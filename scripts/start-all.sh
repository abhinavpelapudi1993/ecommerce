...
echo "============================================"
echo " E-Commerce — Starting All Services"
echo "============================================"
echo ""
...
# Step 2: Start all Docker services (backend + frontend)
...
docker compose up --build -d \
  ...
  customer-portal support-dashboard
echo ""
...
echo ""
echo " Note: Frontend apps are served via nginx (production build)."
echo " For frontend dev with hot reload, use 'npm run start:frontend' instead."
echo "============================================"
